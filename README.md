...
### 1️⃣ Backbone-style BGP Lab (EVE-NG)
...
### 2️⃣ NetOps Automation Pack (Python)
...
(These are linked from earlier portfolio items — ask me for quick demos.)
